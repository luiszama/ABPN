...
<div class="row">
      ...
      <br>
      <input type="text" size="20" id="tema" name="tema" placeholder="Nombre del Documento Recepcional"/>
      <br />
      ...
      <br>
      <input type="text" size="20" id="fechatitulacion" name="fechatitulacion" placeholder="Fecha Examen Profesional"/>
      <br />
      ...
      <br>
      <input type="text" size="20" id="no_titulo" name="no_titulo" placeholder="No. de Autorización Examen Profesional"/>
      <br />
      <br />
