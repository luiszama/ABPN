...
<div class="row">
      ...
      <label for="tema">Nombre del Documento Recepcional:</label>
      <br>
      <input type="text" size="20" id="tema" name="tema" placeholder="Nombre del Documento Recepcional" value="<?=$dt_titulacion['0']->tema;?>"/>
      <br />
     ...
     <label for="Generación">Generación:</label>
      ...
      <label for="Fecha Examen Profesional">Fecha Examen Profesional:</label>
      <br>
      <input type="text" size="20" id="fechatitulacion" name="fechatitulacion" placeholder="Fecha Examen Profesional"  value="<?=$dt_titulacion['0']->fechatitulacion;?>" />
      <br />
      ...
      <label for="No. de Autorización Examen Profesional">No. de Autorización Examen Profesional:</label>
      <br>
      <input name="no_titulo" type="text" id="no_titulo" placeholder="No. de Autorización Examen Profesional" value="<?=$dt_titulacion['0']->no_titulo;?>" size="20"/>
      <br />
      <br />
