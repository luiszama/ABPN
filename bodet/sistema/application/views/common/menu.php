  ...
  <section class="top-bar-section">
    ...
    <ul class="dropdown">
      ...
      <li class="has-dropdown"><a href="#" data-reveal-id="myModal_ofi">Reportes</a>
        <ul class="dropdown">
          <li><a href="#" data-reveal-id="myModal_ofi">Escolares</a></li>
    ...
    <? } ?>
      ...
      <? } ?>
        ...
        <li class="has-dropdown"><a href="#">Clave de Acceso</a>
          ...
          <li class="has-dropdown"><a href="#">Exportar Datos</a>
            ...
            <li><a href="<?=base_url();?>parametros/titulados">&rarr; Titulados</a></li>
            <li><a href="<?=base_url();?>parametros/egresados">&rarr; Egresados</a></li>
            <li><a href="<?=base_url();?>parametros/calificaciones/<?= $data['dt_e'][0]->cicloescolar; ?>">&rarr; Calificaciones</a></li>
      ...
      <li class="divider"></li>
      <li class="has-dropdown"><a href="<?=base_url();?>encuestas">Encuesta</a>
        <ul class="dropdown">
          <li><a href="#" data-reveal-id="myModal_clearen">Limpiar Resultados</a></li>
          <li><a href="<?=base_url();?>encuestas/descargar">&rarr; Descargar Resultados</a></li>
        </ul>
      </li>
      <li class="divider"></li>
      <? } ?>
...
function active()
{
  ...
  <select id="semestrekardex" name="semestrekardex" class="medium">
  		<option selected="selected" DISABLED>Seleccionar opción</option>
  		  ...
  		  <option value="3">Malla Curricular con Calificaciones parte 1</option>
        <option value="4">Malla Curricular con Calificaciones parte 2</option>
        <!-- -------------------------- Malla con calificaciones ---------------------------- -->
        
        <option value="13">1er. Semestre sólo calificaciones</option>
        <option value="14">2do. Semestre sólo calificaciones</option>
        <option value="15">3er. Semestre sólo calificaciones</option>
        <option value="16">4to. Semestre sólo calificaciones</option>
        <option value="17">5to. Semestre sólo calificaciones</option>
        <option value="18">6to. Semestre sólo calificaciones</option>
        <option value="19">7mo. Semestre sólo calificaciones</option>
        <option value="20">8vo. Semestre sólo calificaciones</option>
        
        <option value="todo">Malla Curricular sin calificaciones parte 1</option>
        <option value="1">Malla Curricular sin calificaciones parte 2</option>
        
        <option value="5">1er. Semestre Malla con Calificaciones</option>
        <option value="6">2do. Semestre Malla con Calificaciones</option>
        <option value="7">3er. Semestre Malla con Calificaciones</option>
        <option value="8">4to. Semestre Malla con Calificaciones</option>
        <option value="9">5to. Semestre Malla con Calificaciones</option>
        <option value="10">6to. Semestre Malla con Calificaciones</option>
        <option value="11">7mo. Semestre Malla con Calificaciones</option>
        <option value="12">8vo. Semestre Malla con Calificaciones</option>
  </select>
  </div></div>
  <!--inscripcion reinscripcion -->
...
<!---  /// para maestros - datos alumnos documentacion/// -->
<div id="myModal_clearen" class="reveal-modal">
<h2>Limpiar Encuesta</h2>

  <div class="large-12 columns">
    <a href="<?=base_url();?>encuestas/limpiar" class="button postfix">Limpiar Resultados de Encuesta</a>
  </div>
