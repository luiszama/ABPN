...
function asistencia(data,data2)
{
	...
	document.getElementById(data2).readOnly = false;
      ...
      <br>
      <input name="asistencia_general" type="text" id="asistencia_general" placeholder="Asistencia General" value="<?=$dt_calificaciones['0']->asistencia_general;?>" size="20"  />
      <br />

      <label for="Calificación Final">Calificación Final:</label>
      <br>
      <input name="calificacion_final" type="text" id="calificacion_final" placeholder="Calificación Final" onchange="myFunction('fecha')" value="<?=$dt_calificaciones['0']->calificacion_final;?>" size="20" maxlength="3" />
      <br />
