...
<div class="row">
  ...
  <div class="large-4 columns">
      ...
      <br>
      <label for="trasladoreincorpoacion">Traslado / Reincorporación:</label>
      <br>
      <input name="trasladoreincorpoacion" type="text" id="trasladoreincorpoacion" placeholder="Traslado / Reincorporación" value="<?=$dt_alumno['0']->trasladoreincorpoacion;?>" size="20" />


      <br />
      <br />

      <input type="submit"  class="button postfix" value=" Guardar Datos de Alumno "/>
      </div>
      </form>
      </div>