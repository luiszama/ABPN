...
<table width="800" border="0" cellspacing="0" cellpadding="0">
				<tr>
                  <td width="372" bgcolor="#FFFFFF">Nombre del Documento Recepcional</td>
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td bgcolor="#FFFFFF">Fecha Examen Profesional</td>
  ...
  <tr>
    <td bgcolor="#FFFFFF">No. de Autorización Examen Profesional</td>
