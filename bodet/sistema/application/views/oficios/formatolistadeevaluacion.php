...
<body>
<?php
$etiquetapendejadelasepnumero = ".0";
$etiquetapendejadelasepletra = ".cero";
...
<table border="0" bordercolor="" style="background-color:" width="100%" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <?php if($dt_materia['0']->licenciatura == 5) { ?>
    <strong>LICENCIATURA EN <?=$this->user->mi_join($dt_materia['0']->licenciatura,'especialidades','id','label');?></strong>
    <?php } else { ?>
  ...
  <tr>
    <td>MATERIA: <br>&nbsp;</td>
    <td colspan="4" align="center"><?=$dt_materia['0']->materia;?> <br> CLAVE MATERIA: <?=$dt_materia['0']->clave_especialidad;?></td>
    <td> </td>
  </tr>
  <tr>
    <td> &nbsp;</td>
  ...
  border-top: solid 1px #000;
  border-bottom: solid 1px #000;
  border-right: solid 1px #000;margin-right: 1em;">&nbsp;X</div></td>
    <td>GRUPO: </td>
    <td></td>
  ...
  <tr>
    <td><? if($this->uri->segment(4) != 0){echo "PERIODO EVALUADO";} ?></td>
    <td  align="center"><? if($this->uri->segment(4) != 0){echo $this->uri->segment(4);} ?></td>
...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <th rowspan="2" scope="col"><span style="font-size:9px;">Firma del <br> Alumno</span></th>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="center"><? if($asistencia == 100){echo "100";}else{echo substr($asistencia, 0,2);} ?></td>
