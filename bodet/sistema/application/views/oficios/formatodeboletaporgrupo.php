...
<title>formato de boleta por grupo</title>
<style type="text/css">
body,td,th {
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="75%" align="center"><p>&quot;<?=$dt_escuela['0']->nom_escuela;?>&quot;<br />
      ...
      ESPECIALIDAD: <?=$this->user->mi_join($especialidad,'especialidades','id','label');?><br />
...
foreach($datasemestre as $valor):?>
    ...
    <td align="right" bgcolor="#CCCCCC"><? $cal += $valor->calificacion_final ?><? if($valor->calificacion_final == 10){echo "10";}else{echo substr($valor->calificacion_final, 0,1);} ?></td>
    <td align="right" bgcolor="#CCCCCC"><? if($valor->asistencia_general == 100){echo "100";}else{echo substr($valor->asistencia_general, 0,2);} ?></td>
  ...
  <tr>
    ...
    <td align="right" style="border:#000 solid 1px;"><? $final = round($cal / $n, 1); if($final == 10){echo "10";}else{echo substr($final, 0,1);} ?></td>
