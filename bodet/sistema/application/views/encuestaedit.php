...
document.getElementById("p"+id+"r1").value = "";
document.getElementById("p"+id+"r2").value = "";
document.getElementById("p"+id+"r3").value = "";
document.getElementById("p"+id+"r4").value = "";
document.getElementById("p"+id+"r5").value = "";
}
</script>
<!-- breadcrumbs  -->
...
<!-- breadcrumbs  -->
<div class="row">
<?php echo form_open('encuestas/savedit','class="custom"'); ?>
		<div class="large-12 columns">
            <hr />

        <div class="large-12 columns">
        <label for="checkbox1">
        <input type="checkbox" <? if($ec[0]->status == 1){echo "CHECKED";} ?> name="activar" value=1> ¡Si tacha el campo se Activara la Encueta!</label>
        <br><br>
        </div>
        ...
        <div class="large-2 columns">
        <label for="p1r5">Limpiar Pregunta</label>
        <br>
        <input type="button" onclick="formReset(1)" class="button postfix" value="Limpiar">
        </div>
        ...
        <label for="p1r5">Limpiar Pregunta</label>
        <br>
        <input type="button" onclick="formReset(2)" class="button postfix" value="Limpiar">
        </div>
        ...
        <label for="p1r5">Limpiar Pregunta</label>
        <br>
        <input type="button" onclick="formReset(3)" class="button postfix" value="Limpiar">
        </div>
        ...
        <label for="p1r5">Limpiar Pregunta</label>
        <br>
        <input type="button" onclick="formReset(4)" class="button postfix" value="Limpiar">
        </div>
        ...
        <label for="p1r5">Limpiar Pregunta</label>
        <br>
        <input type="button" onclick="formReset(5)" class="button postfix" value="Limpiar">
        </div>
