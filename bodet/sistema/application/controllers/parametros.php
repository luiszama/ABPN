...
function titulados() {
$data['datos'] = $this->m_parametros->tituladosfile();
$this->load->view('tituladosfile', $data);
}
function egresados() {
$data['datos'] = $this->m_parametros->egresadosfile();
$this->load->view('egresadosfile', $data);
}
function calificaciones() {

$data['cf'] = $this->m_parametros->califile($this->uri->segment(3));
$this->load->view('calificacionesfile', $data);
}
