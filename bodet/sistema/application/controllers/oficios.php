  ...
  function index()
  {
    ...
    {	
	  ...
	  switch ($oficiosss) {
		...
		{
		case "todo";	
		$this->load->view('oficios/formatokardex00', $data);
		break;
		case 1:
		$this->load->view('oficios/formatokardex01', $data);
		break;
		case 2:
		case 3:
		...
		break;
		case 4:
		$this->load->view('oficios/formatokardex4', $data);
		break;
		case 5:
		case 6:
		case 7:
		case 8:
		$this->load->view('oficios/formatokardex5', $data);
		break;
		case 9:
		case 10:
		case 11:
		case 12:
		$this->load->view('oficios/formatokardex6', $data);
		break;
		case 13:
		case 14:
		case 15:
		case 16:
		$this->load->view('oficios/formatokardex7', $data);
		case 17:
		case 18:
		case 19:
		case 20:
		$this->load->view('oficios/formatokardex8', $data);
    ...
    if($session_data['id_nivel'] >= 2)
    {
      ...
      $data['semestre'] = $this->uri->segment(5);
	  $data['dt_escuela'] = $this->alumnos->datos_escuela();
	  $data['dt_materia'] = $this->m_parametros->datos_materia($this->uri->segment(3));
	  $data ['a_m_calificacion'] = $this->m_academico->alumnos_de_materia($this->uri->segment(3),$this->uri->segment(5),$data['dt_escuela'][0]->cicloescolar);
	  $data ['a_m_calificacion_sex_h'] = $this->m_academico->alumnos_de_materia_sex($this->uri->segment(3),$this->uri->segment(5),$data['dt_escuela'][0]->cicloescolar,1);////el segundo valor es el tipo de sexo para el contador
	  $data ['a_m_calificacion_sex_m'] = $this->m_academico->alumnos_de_materia_sex($this->uri->segment(3),$this->uri->segment(5),$data['dt_escuela'][0]->cicloescolar,2);////el segundo valor es el tipo de sexo para el contador
	  ////
    ...
    if($session_data['id_nivel'] >= 2)
    {
	  $data['dt_escuela'] = $this->alumnos->datos_escuela();
	  $data['dt_materia'] = $this->m_parametros->datos_materia($this->uri->segment(3));
	  $data ['a_m_calificacion'] = $this->m_academico->alumnos_de_materia($this->uri->segment(3),$this->uri->segment(4),$data['dt_escuela'][0]->cicloescolar);
	  $data ['a_m_calificacion_sex_h'] = $this->m_academico->alumnos_de_materia_sex($this->uri->segment(3),$this->uri->segment(4),$data['dt_escuela'][0]->cicloescolar,1);////el segundo valor es el tipo de sexo para el contador
	  $data ['a_m_calificacion_sex_m'] = $this->m_academico->alumnos_de_materia_sex($this->uri->segment(3),$this->uri->segment(4),$data['dt_escuela'][0]->cicloescolar,2);////el segundo valor es el tipo de sexo para el contador
	  ////
